#
#  Be sure to run `pod spec lint CHAction.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.social_media_url   = "http://blog.cr185.com"

  # ――― Platform Specifics ――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.platform     = :ios
  s.source       = { :git => "https://github.com/croef/CHAction.git", :tag => "0.0.1" }
